...
{
    public partial class ucStudentwiseMonthlyAttendanceReport : UserControl
    {
        public ucStudentwiseMonthlyAttendanceReport()
        {
            InitializeComponent();
            loadCmbOrganization();
        }
        ...
        private void ucStudentwiseMonthlyAttendanceReport_Load(object sender, EventArgs e)
        {
        ...
        private void btn_LoadREcords_Click(object sender, EventArgs e)
        {
            ...
            FormReport frm = new FormReport("Report - Student Wise Attendance (Monthly)", "StudentsMonthlyAttendance", ClassID, SectionId, SessionID, dtp_Date.Value);
            frm.Show();
        }
    }
}
